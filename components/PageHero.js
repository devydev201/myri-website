...
export default function PageHero({ eyebrow, title, accent, desc, img, pos = "center center", breadcrumb, heroClass = "", imgRatio }) {
  return (
    <section className={heroClass ? `${heroClass}-section` : ""} style={{ position: "relative", overflow: "hidden", minHeight: 380, aspectRatio: imgRatio || undefined, display: "flex", alignItems: "center" }}>
      <div
        className={heroClass}
        style={{
          position: "absolute",
