          ...
          <div>
            ...
            <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 6 }}>
              <a href={SITE.phoneHref} style={{ fontSize: 11.5, color: "rgba(255,255,255,.6)", textDecoration: "none", display: "flex", alignItems: "center", gap: 6 }}>
                <Phone size={12} color="rgba(255,255,255,.6)" /> {SITE.phone}
              </a>
              <a href={SITE.emailHref} style={{ fontSize: 11.5, color: "rgba(255,255,255,.6)", textDecoration: "none", display: "flex", alignItems: "center", gap: 6 }}>
                <Mail size={12} color="rgba(255,255,255,.6)" /> {SITE.email}
              </a>
              <span style={{ fontSize: 11.5, color: "rgba(255,255,255,.6)", display: "flex", alignItems: "center", gap: 6 }}>
                <MapPin size={12} color="rgba(255,255,255,.6)" /> {SITE.address}
              </span>
            </div>
          </div>
          {COLS.map((col) => (
