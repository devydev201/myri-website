export const FAQS = [
  ...
  },
  {
    ...
    a: [
      "It depends on volume and staffing, but for most small-to-mid chiropractic practices outsourcing wins on total cost and consistency. Outsourcing makes the most sense when billing is one person's part-time responsibility, when denials or AR over 90 days are climbing, or when the practice can't absorb the risk of that person leaving. In-house billing makes sense when volume justifies a dedicated, trained biller and the practice has systems to supervise the work.",
  ...
  {
    q: "Can chiropractors bill Medicare for maintenance care?",
    a: [
      "No. Medicare does not pay for chiropractic maintenance care \u2014 it only covers manual manipulation of the spine to correct a subluxation when the care is active treatment expected to improve the patient's condition. Once care becomes maintenance or supportive, Medicare considers it non-covered.",
      "This is one of the most common sources of Medicare denials and audit risk. The AT (Acute Treatment) modifier signals active treatment, and the documentation must show a treatment plan with measurable improvement goals. When care shifts to maintenance, the correct step is an Advance Beneficiary Notice (ABN) so the patient can be billed directly \u2014 not continuing to bill Medicare as if the care were still active.",
    ],
  },
  {
    q: "What happens if a chiropractic claim is denied for medical necessity?",
    a: [
      "A medical-necessity denial can usually be appealed and overturned when the documentation supports the care \u2014 it is rarely the end of the claim. The appeal succeeds or fails on whether the treatment notes establish an active problem, a treatment plan, and measurable functional improvement tied to the diagnosis billed.",
      "The practical process is to identify the denial fast, pull the supporting documentation, and file a formal appeal within the payer's deadline. Denials that go unappealed are simply written off as lost revenue \u2014 which is why a consistent appeal process matters more than any single claim. MYRI appeals every denial within 72 hours rather than writing it off.",
    ],
  },
  {
    q: "Does insurance cover chiropractic care for auto accident injuries?",
    a: [
      "Usually yes \u2014 auto accident chiropractic care is most often paid through the patient's auto insurance rather than their health plan. In no-fault states that means Personal Injury Protection (PIP); MedPay may also apply, and in some cases the at-fault driver's liability coverage or an attorney lien covers the care.",
      "Which payer applies, and in what order, depends on the state and the patient's coverage \u2014 and getting that sequence wrong is a leading cause of unpaid accident claims. PIP has strict filing windows and treatment-timing rules, MedPay often sits behind PIP, and lien cases are paid from the eventual settlement. Coordinating these correctly is a core part of personal-injury chiropractic billing.",
    ],
  },
];
