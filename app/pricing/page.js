      ...
      <section style={{ padding: "0 24px 64px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16 }} className="save-grid">
            {[
              { Icon: DollarSign, t: "Eliminate Staff Overhead", d: "No salary, benefits, payroll taxes, or training costs for in-house billing staff. MYRI's fee is typically less than one part-time biller." },
              ...
              <motion.div key={c.t} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-40px" }}
                ...
                <div style={{ width: 44, height: 44, borderRadius: 11, background: COLORS.navy, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 12 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 16, padding: 28, boxShadow: "0 8px 28px rgba(13,51,73,.1)" }}>
            {quoteSubmitted ? (
              ...
              <form name="pricing-form-1" method="POST" data-netlify="true" netlify-honeypot="bot-field" onSubmit={handleQuoteSubmit}>
                ...
                <p style={{ fontSize: 10.5, color: COLORS.gray, textAlign: "center", marginTop: 10, display: "flex", alignItems: "center", justifyContent: "center", gap: 5 }}><Lock size={11} color={COLORS.gray} /> HIPAA-compliant · No obligation · Response within 24 hours</p>
              </form>
            )}
          </div>
        </div>
