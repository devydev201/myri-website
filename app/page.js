  ...
  return (
    <div>
      ...
      <section style={{ position: "relative", overflow: "hidden", minHeight: 380, display: "flex", alignItems: "center" }}>
        ...
        <style>{`@media (max-width: 860px) { .hero-grid { grid-template-columns: 1fr !important; } .hero-bg { background-position: left center !important; } }`}</style>
      </section>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }} className="remote-cards">
            {[
              ...
              <motion.div key={c.t} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                ...
                <div style={{ width: 44, height: 44, borderRadius: 11, background: "rgba(13,51,73,.6)", border: "1px solid rgba(127,216,201,.2)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 12 }}>
                  <c.Icon size={22} color={COLORS.mint} strokeWidth={1.6} />
                </div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16 }} className="why-grid">
            {[
              ...
              { Icon: XCircle, t: "Medical Necessity Denials", d: "Payers routinely deny chiropractic claims for lack of medical necessity. MYRI builds bulletproof appeal packages and recovers denied revenue — with a formal response submitted within 72 hours of every denial." },
            ].map((c, i) => (
              <motion.div key={c.t} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-40px" }}
                ...
                <div style={{ width: 44, height: 44, borderRadius: 11, background: COLORS.navy, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
                  <c.Icon size={22} color={COLORS.mint} strokeWidth={1.6} />
                </div>
            ...
            {SERVICES.map((s, i) => (
              <motion.div key={s.title} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-60px" }}
                ...
                <Link href="/services" style={{ display: "block", textDecoration: "none", background: "#fff", border: `1px solid ${COLORS.grayLight}`, borderRadius: 14, padding: 22, height: "100%", boxSizing: "border-box" }}>
                  <div style={{ width: 44, height: 44, borderRadius: 11, background: COLORS.navy, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
                    <s.Icon size={22} color={COLORS.mint} strokeWidth={1.8} />
                  </div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 44, alignItems: "start" }} className="audit-grid">
          <div>
            ...
            <p style={{ fontSize: 12.5, color: COLORS.gray, display: "flex", alignItems: "flex-start", gap: 6 }}>
              ...
              Serving Lake Mary, Orlando, Sanford, Heathrow, Longwood, Altamonte Springs, Winter Park, Kissimmee, and all nationwide.
            </p>
          </div>
          ...
          <div style={{ background: "#fff", border: `1px solid ${COLORS.grayLight}`, borderRadius: 16, padding: 28, boxShadow: "0 8px 28px rgba(13,51,73,.08)" }}>
            {auditSubmitted ? (
              ...
              <form name="index-form-1" method="POST" data-netlify="true" netlify-honeypot="bot-field" onSubmit={handleAuditSubmit}>
                ...
                <p style={{ fontSize: 10.5, color: COLORS.gray, textAlign: "center", marginTop: 10, display: "flex", alignItems: "center", justifyContent: "center", gap: 5 }}><Lock size={11} color={COLORS.gray} /> HIPAA-compliant · Your info is never shared · No obligation, ever</p>
              </form>
            )}
          </div>
        </div>
